...
The `home-routes` handler in the `dev-academy-2021.routes.home` namespace
...
The `home-page` function will in turn call the `dev-academy-2021.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `dev-academy-2021.handler` namespace:
...
Request middleware functions are located under the `dev-academy-2021.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `dev-academy-2021.dev-middleware` namespace found in
